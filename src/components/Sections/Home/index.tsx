...
export function Home() {
  ...
  return (
    <>
      ...
      <motion.div
        ref={refHome}
        className="w-screen max-w-full after:absolute after:bottom-0 after:left-0 after:right-0 after:h-40 after:bg-gradient-to-t after:from-purple-500/20"
        data-section="home"
      >
        <div className="bg-app bg-cover">
          <div className={classes}>
            <div className="flex h-screen flex-col items-center justify-center gap-1">
              ...
              <motion.div
                className="flex h-16 gap-6 my-10 flex-col md:flex-row lg:flex-row"
                variants={slideUpVariants}
                initial="initial"
                animate="animate"
              >
